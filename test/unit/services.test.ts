...
import info from './data/services/get_info'
import explicitInfo from './data/services/get_info_explicit'
import capabilities from './data/services/get_capabilities'
import weather from './data/services/get_capabilities_weather'
import forecast from './data/services/get_capabilities_weather_forecast'
import createSubscription  from './data/services/post_subscription'
import createSubscriptionExplicit  from './data/services/post_subscription_explicit'
import createSubscriptionExecution  from './data/services/post_subscription_execution'
import deleteSubscription  from './data/services/delete_subscription'
import deleteSubscriptions  from './data/services/delete_subscriptions'


const client = new SmartThingsClient(
	new BearerTokenAuthenticator('c486f217-e128-4915-a5c9-947603f2f1c1'), {
